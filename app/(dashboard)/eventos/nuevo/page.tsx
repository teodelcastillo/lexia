...
export const metadata = {
  title: 'Nuevo Evento',
  description: 'Crear un nuevo evento o plazo legal',
}

interface NewEventoPageProps {
  searchParams: Promise<{
    caso?: string
  }>
}

export default async function NewEventoPage({ searchParams }: NewEventoPageProps) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Registre un nuevo evento o plazo legal
          </p>
        </div>
      </div>
